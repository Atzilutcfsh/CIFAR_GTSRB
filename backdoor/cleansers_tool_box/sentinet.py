...
class SentiNet():
    ...
    def cleanse(self):
        ...
        sampler = RandomSampler(clean_subset, num_samples=2000) 
        
        clean_loader = torch.utils.data.DataLoader(clean_subset, batch_size=100, sampler=sampler, shuffle=False, drop_last=False, num_workers=4, pin_memory=True)
